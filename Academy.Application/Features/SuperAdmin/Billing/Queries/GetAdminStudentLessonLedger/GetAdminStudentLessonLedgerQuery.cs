...
namespace Academy.Application.Features.SuperAdmin.Billing.Queries.GetAdminStudentLessonLedger;

public sealed record GetAdminStudentLessonLedgerQuery(int LessonId, int StudentId)
    : IRequest<Result<StudentLessonLedgerDto>>;

public sealed class GetAdminStudentLessonLedgerQueryHandler(IApplicationDbContext dbContext)
    : IRequestHandler<GetAdminStudentLessonLedgerQuery, Result<StudentLessonLedgerDto>>
{
    public async Task<Result<StudentLessonLedgerDto>> Handle(
        GetAdminStudentLessonLedgerQuery request,
